...
class EthHedgeStrategy(IStrategy):
    """Conservative ETH short hedge strategy for futures dry-run."""
    ...
    minimal_roi = {"0": 0.035, "120": 0.018, "240": 0.0}
    stoploss = -0.045
    trailing_stop = False
    ...
    def bot_start(self, **kwargs: Any) -> None:
        ...
        send_optional_telegram_alert("ETH hedge bot started in dry-run mode.")
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[defensive_short, ["enter_short", "enter_tag"]] = (
            1,
            "eth_defensive_ema_rsi_volume_short",
        )
        return dataframe
    ...
    def custom_stake_amount(
        ...
        **kwargs: Any,
        ...
        if stake <= 0:
            ...
            send_optional_telegram_alert("ETH risk guard blocked a trade: position cap below minimum.")
    ...
    def bot_loop_start(self, current_time: datetime, **kwargs: Any) -> None:
        ...
        if active and not getattr(self, "_kill_switch_alerted", False):
            ...
            send_optional_telegram_alert("ETH kill switch activated. New entries are blocked.")
    ...
    def _block_entry(self, reason: str) -> bool:
        ...
        send_optional_telegram_alert(f"ETH risk guard blocked a trade: {reason}")
        return False
    ...
    def _trade_age(current_time: datetime, open_date: datetime | None) -> timedelta | None:
        if open_date is None:
            return None
        return current_time - EthHedgeStrategy._normalize_datetime(open_date, current_time)
