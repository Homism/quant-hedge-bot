...
tar \
  ...
  -czf "$ARCHIVE" \
  configs user_data_btc user_data_eth user_data_sol user_data_xaut dashboard risk_service docs scripts docker-compose.yml README.md AGENTS.md .env.example
