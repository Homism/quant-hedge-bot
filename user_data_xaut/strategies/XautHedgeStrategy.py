...
class XautHedgeStrategy(IStrategy):
    """Conservative XAUT short hedge strategy, gated by market validation."""
    ...
    # XAUT is Tether Gold, so this must only run when a futures pair is verified.
    minimal_roi = {"0": 0.02, "120": 0.01, "240": 0.0}
    stoploss = -0.03
    trailing_stop = False
    ...
    def bot_start(self, **kwargs: Any) -> None:
        ...
        send_optional_telegram_alert("XAUT hedge bot started in dry-run mode after validation.")
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[defensive_short, ["enter_short", "enter_tag"]] = (
            1,
            "xaut_defensive_ema_rsi_volume_short",
        )
        return dataframe
    ...
    def custom_stake_amount(
        ...
        **kwargs: Any,
        ...
        if stake <= 0:
            ...
            send_optional_telegram_alert("XAUT risk guard blocked a trade: position cap below minimum.")
    ...
    def bot_loop_start(self, current_time: datetime, **kwargs: Any) -> None:
        ...
        if active and not getattr(self, "_kill_switch_alerted", False):
            ...
            send_optional_telegram_alert("XAUT kill switch activated. New entries are blocked.")
    ...
    def _block_entry(self, reason: str) -> bool:
        ...
        send_optional_telegram_alert(f"XAUT risk guard blocked a trade: {reason}")
        return False
    ...
    def _trade_age(current_time: datetime, open_date: datetime | None) -> timedelta | None:
        if open_date is None:
            return None
        return current_time - XautHedgeStrategy._normalize_datetime(open_date, current_time)
